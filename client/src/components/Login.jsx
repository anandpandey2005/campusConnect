  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-r from-indigo-800 via-purple-700 to-blue-700 relative overflow-hidden p-4">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" fill="rgba(255,255,255,0.05)" /></svg>\')',
        }}
      ></div>
      ...
      <div className="relative z-10 backdrop-blur-lg bg-white/10 border border-white/20 shadow-2xl rounded-2xl p-8 w-full max-w-md text-white transition-all duration-300 hover:shadow-yellow-400/50">
        ...
        {/* Messages */}
        {error && (
          <p className="text-red-300 text-center font-medium mt-6 p-3 bg-red-900/30 border border-red-700 rounded-lg">
            {error}
          </p>
        )}
        {success && (
          <p className="text-green-300 text-center font-medium mt-6 p-3 bg-green-900/30 border border-green-700 rounded-lg">
            {success}
          </p>
        )}
